...
bool ImGui_ImplSdlGL2_Init(HWND hWnd)
{
	...
	style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.8f, 0.8f, 0.8f, 0.560f);
	style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.26f, 0.59f, 0.98f, 0.67f);
	style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.26f, 0.59f, 0.98f, 0.95f);
	style.Colors[ImGuiCol_PlotLines] = ImVec4(0.39f, 0.39f, 0.39f, 1.f);
	style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.f, 0.43f, 0.35f, 1.f);
	style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.9f, 0.7f, 0.f, 1.f);
	style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.f, 0.45f, 0.00f, 1.f);
	style.Colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.0f, 0.0f, 0.0f, 0.35f);
	...
	style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.098f, 0.098f, 0.098f, 1.00f);
	...
	style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.39f, 0.39f, 0.39f, 0.80f);
	style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.49f, 0.49f, 0.49f, 0.80f);
	style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.49f, 0.49f, 0.49f, 1.00f);
	style.Colors[ImGuiCol_CheckMark] = ImVec4(0.50f, 0.64f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.50f, 0.64f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.50f, 0.72f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_Button] = ImVec4(0.50f, 0.64f, 0.13f, 0.90f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.50f, 0.64f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.50f, 0.72f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_Header] = ImVec4(0.50f, 0.64f, 0.13f, 0.40f);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.50f, 0.64f, 0.13f, 0.90f);
	style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.50f, 0.64f, 0.13f, 1.00f);
	style.Colors[ImGuiCol_Column] = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
	style.Colors[ImGuiCol_ColumnHovered] = ImVec4(0.26f, 0.59f, 0.98f, 0.78f);
	style.Colors[ImGuiCol_ColumnActive] = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
	style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.50f, 0.72f, 0.13f, 0.50f);
	style.Colors[ImGuiCol_CloseButton] = ImVec4(0.59f, 0.59f, 0.59f, 0.50f);
	style.Colors[ImGuiCol_CloseButtonHovered] = ImVec4(0.98f, 0.39f, 0.36f, 1.00f);
	style.Colors[ImGuiCol_CloseButtonActive] = ImVec4(0.98f, 0.39f, 0.36f, 1.00f);

	style.Colors[ImGuiCol_Separator] = ImVec4(0.23f, 0.23f, 0.23f, 1.00f);
...
void ImGui_ImplSdlGL2_NewFrame()
{
	...
	ImGuiIO& io = ImGui::GetIO();
	io.DisplaySize = ImVec2((float)g_Screen.iWidth, (float)g_Screen.iHeight);
