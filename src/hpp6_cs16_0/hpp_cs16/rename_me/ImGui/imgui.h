...
typedef int ImDrawListFlags;        // flags: for ImDrawList                    // enum ImGuiStyleVar_
...
namespace ImGui
{
	...
	IMGUI_API void			Separator (float size);
	...
	IMGUI_API bool          ButtonLink(const char* label, const ImVec2& size = ImVec2(0, 0));       // button link
