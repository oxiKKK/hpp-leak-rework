...
struct ImVec2
{
	...
	inline bool IsZero() { return x == 0.0F && y == 0.0F; }
...
namespace ImGui
{
    ...
    // Cursor / Layout
    IMGUI_API void          Separator(float CustomWidth = 0.0f);                                // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
	...
	bool					BeginCombo (const char* label, const char* preview_value, ImVec2 popup_size);
   // IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API ImGuiContext* CreateContext(void* (__cdecl *malloc_fn)(size_t) = NULL, void (__cdecl *free_fn)(void*) = NULL);
...
struct ImGuiIO
{
    ...
    void*       (__cdecl *MemAllocFn)(size_t sz);
    void        (__cdecl *MemFreeFn)(void* ptr);
...
struct ImDrawList
{
	...
	IMGUI_API void	AddGradientRect(const ImVec2& a, const ImVec2& b, const ImColor& clr_a, const ImColor& clr_b); 
	IMGUI_API void	AddGradientBar(const ImVec2& a, const ImVec2& b, const ImColor& clr_a, const ImColor& clr_b);
