...
ImFont* ImFontAtlas::AddFontDefault (const ImFontConfig* font_cfg_template)
{
	...
	{
		font_cfg.OversampleH = font_cfg.OversampleV = 8;
		font_cfg.PixelSnapH = true;
	}
	if (font_cfg.Name[0] == '\0') strcpy (font_cfg.Name, "lucida-grande.ttf, 10px");
	...
	// font_change
	ImFont* font = AddFontFromMemoryCompressedTTF (lucida_compressed_data, lucida_compressed_size, 10.f, &font_cfg, ranges);
	return font;
}
