...
static bool             BeginChildEx2(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
...
static bool ImGui::BeginChildEx2(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* parent_window = g.CurrentWindow;
	...
	if (!border)
		g.Style.ChildBorderSize = 0.0f;
	bool ret = Begin2(name, NULL, flags);
	g.Style.ChildBorderSize = backup_border_size;
...
{
	ImGuiWindow* window = GetCurrentWindow();
	return BeginChildEx2(str_id, window->GetID(str_id), size_arg, border, extra_flags);
}
...
bool ImGui::Begin2(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
	ImGuiContext& g = *GImGui;
	const ImGuiStyle& style = g.Style;
	IM_ASSERT(name != NULL && name[0] != '\0');     // Window name required
			...
			else
			{
				...
				// Borders
				{
					...
					if (border_size > 0.0f && !(window->Flags & ImGuiWindowFlags_NoBackground))
					{
						...
						ImVec4 border_col = ImGui::ColorConvertU32ToFloat4(GetColorU32(ImGuiCol_Border));
						ImVec4 shadow = border_col;

						shadow.w = border_col.w / 213.f;

						window->DrawList->AddLine(window->Pos - ImVec2(7, 7), ImVec2(window->Pos.x - 7, window->Pos.y + window->Size.y + 7), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 7, window->Pos.y + window->Size.y + 7), window->Pos + window->Size + ImVec2(7, 7), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(7, 7), ImVec2(window->Pos.x + window->Size.x + 7, window->Pos.y - 7), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(7, 7), ImVec2(window->Pos.x + 15.f, window->Pos.y - 7), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 7), ImVec2(window->Pos.x + window->Size.x + 7, window->Pos.y - 7), ImColor(shadow), border_size);

						shadow.w = border_col.w / 123.f;

						window->DrawList->AddLine(window->Pos - ImVec2(6, 6), ImVec2(window->Pos.x - 6, window->Pos.y + window->Size.y + 6), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 6, window->Pos.y + window->Size.y + 6), window->Pos + window->Size + ImVec2(6, 6), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(6, 6), ImVec2(window->Pos.x + window->Size.x + 6, window->Pos.y - 6), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(6, 6), ImVec2(window->Pos.x + 15.f, window->Pos.y - 6), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 6), ImVec2(window->Pos.x + window->Size.x + 6, window->Pos.y - 6), ImColor(shadow), border_size);


						shadow.w = border_col.w / 83.f;

						window->DrawList->AddLine(window->Pos - ImVec2(5, 5), ImVec2(window->Pos.x - 5, window->Pos.y + window->Size.y + 5), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 5, window->Pos.y + window->Size.y + 5), window->Pos + window->Size + ImVec2(5, 5), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(5, 5), ImVec2(window->Pos.x + window->Size.x + 5, window->Pos.y - 5), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(5, 5), ImVec2(window->Pos.x + 15.f, window->Pos.y - 5), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 5), ImVec2(window->Pos.x + window->Size.x + 5, window->Pos.y - 5), ImColor(shadow), border_size);

						shadow.w = border_col.w / 53.f;

						window->DrawList->AddLine(window->Pos - ImVec2(4, 4), ImVec2(window->Pos.x - 4, window->Pos.y + window->Size.y + 4), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 4, window->Pos.y + window->Size.y + 4), window->Pos + window->Size + ImVec2(4, 4), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(4, 4), ImVec2(window->Pos.x + window->Size.x + 4, window->Pos.y - 4), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(4, 4), ImVec2(window->Pos.x + 15.f, window->Pos.y - 4), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 4), ImVec2(window->Pos.x + window->Size.x + 4, window->Pos.y - 4), ImColor(shadow), border_size);

						shadow.w = border_col.w / 33.f;

						window->DrawList->AddLine(window->Pos - ImVec2(3, 3), ImVec2(window->Pos.x - 3, window->Pos.y + window->Size.y + 3), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 3, window->Pos.y + window->Size.y + 3), window->Pos + window->Size + ImVec2(3, 3), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(3, 3), ImVec2(window->Pos.x + window->Size.x + 3, window->Pos.y - 3), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(3, 3), ImVec2(window->Pos.x + 15.f, window->Pos.y - 3), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 3), ImVec2(window->Pos.x + window->Size.x + 3, window->Pos.y - 3), ImColor(shadow), border_size);

						shadow.w = border_col.w / 13.f;

						window->DrawList->AddLine(window->Pos - ImVec2(2, 2), ImVec2(window->Pos.x - 2, window->Pos.y + window->Size.y + 2), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 2, window->Pos.y + window->Size.y + 2), window->Pos + window->Size + ImVec2(2, 2), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(2, 2), ImVec2(window->Pos.x + window->Size.x + 2, window->Pos.y - 2), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(2, 2), ImVec2(window->Pos.x + 15.f, window->Pos.y - 2), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 2), ImVec2(window->Pos.x + window->Size.x + 2, window->Pos.y - 2), ImColor(shadow), border_size);

						shadow.w = border_col.w / 3.f;

						window->DrawList->AddLine(window->Pos - ImVec2(1, 1), ImVec2(window->Pos.x - 1, window->Pos.y + window->Size.y + 1), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x - 1, window->Pos.y + window->Size.y + 1), window->Pos + window->Size + ImVec2(1, 1), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos + window->Size + ImVec2(1, 1), ImVec2(window->Pos.x + window->Size.x + 1, window->Pos.y - 1), ImColor(shadow), border_size);
						window->DrawList->AddLine(window->Pos - ImVec2(1, 1), ImVec2(window->Pos.x + 15.f, window->Pos.y - 1), ImColor(shadow), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x + 21.f + text_size.x, window->Pos.y - 1), ImVec2(window->Pos.x + window->Size.x + 1, window->Pos.y - 1), ImColor(shadow), border_size);

						window->DrawList->AddLine(window->Pos, ImVec2(window->Pos.x, window->Pos.y + window->Size.y), GetColorU32(ImGuiCol_Border), border_size);
						window->DrawList->AddLine(ImVec2(window->Pos.x, window->Pos.y + window->Size.y), window->Pos + window->Size, GetColorU32(ImGuiCol_Border), border_size);
						window->DrawList->AddLine(window->Pos + window->Size, ImVec2(window->Pos.x + window->Size.x, window->Pos.y), GetColorU32(ImGuiCol_Border), border_size);
